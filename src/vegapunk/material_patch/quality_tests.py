...
# Local
from gnn_model.prediction import load_sample_predictions
from gnn_model.evaluation_metrics import scatter_xy_data, plot_boxplots, \
    save_figure
...
def qt_internal_forces_equilibrium(predictions_dir, is_save_fig=False,
    ...
    for filename in directory_list:
        ...
        int_forces = np.array(sample_results['node_internal_forces'])
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
