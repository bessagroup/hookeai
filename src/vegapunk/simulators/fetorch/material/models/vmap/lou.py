...
class LouZhangYoonVMAP(ConstitutiveModel):
    ...
    def state_update(self, inc_strain, state_variables_old):
        ...
        plastic_step_output = self._plastic_step(
            is_elastic_step, e_trial_strain_mf, e_consistent_tangent,
            acc_p_strain_old, E, G, hardening_law, hardening_parameters,
            a_hardening_law, a_hardening_parameters, b_hardening_law,
            b_hardening_parameters, c_hardening_law, c_hardening_parameters,
            d_hardening_law, d_hardening_parameters, is_associative_hardening,
            su_conv_tol, su_max_n_iterations)
