...
def gauss_quadrature_2d(n_gauss, domain):
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        if n_gauss == 1:
            gp_coords = {'1': (1.0/3.0, 1.0/3.0)}
            gp_weights = {'1': 1.0/2.0}
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        elif n_gauss == 3:
            gp_coords = {'1': (1.0/6.0, 1.0/6.0),
                         '2': (2.0/3.0, 1.0/6.0),
                         '3': (1.0/6.0, 2.0/3.0)}
...
def gauss_quadrature_3d(n_gauss, domain):
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            ...
            gp_coords = {'1': ((5.0 - np.sqrt(5))/20.0,
                               (5.0 - np.sqrt(5))/20.0,
                               (5.0 - np.sqrt(5))/20.0),
                         '2': ((5.0 + 3.0*np.sqrt(5))/20.0,
                               (5.0 - np.sqrt(5))/20.0,
                               (5.0 - np.sqrt(5))/20.0),
                         '3': ((5.0 - np.sqrt(5))/20.0,
                               (5.0 + 3.0*np.sqrt(5))/20.0,
                               (5.0 - np.sqrt(5))/20.0),
                         '4': ((5.0 - np.sqrt(5))/20.0,
                               (5.0 - np.sqrt(5))/20.0,
                               (5.0 + 3.0*np.sqrt(5))/20.0)}
