...
class FEHexa8(ElementType):
    ...
    """
    def __init__(self, n_gauss=8, device_type='cpu'):
        """Constructor.
        ...
        self._gp_coords, self._gp_weights = \
            gauss_quadrature(n_gauss, domain='hexahedral', device=self._device)
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    def eval_shapefun(self, local_coords):
        ...
        shape_fun = \
            torch.stack([(1.0/8.0)*(1.0 - c1)*(1.0 - c2)*(1.0 - c3),
                         (1.0/8.0)*(1.0 + c1)*(1.0 - c2)*(1.0 - c3),
                         (1.0/8.0)*(1.0 + c1)*(1.0 + c2)*(1.0 - c3),
                         (1.0/8.0)*(1.0 - c1)*(1.0 + c2)*(1.0 - c3),
                         (1.0/8.0)*(1.0 - c1)*(1.0 - c2)*(1.0 + c3),
                         (1.0/8.0)*(1.0 + c1)*(1.0 - c2)*(1.0 + c3),
    ...
    def eval_shapefun_local_deriv(self, local_coords):
        ...
        shape_fun_local_deriv = \
            torch.stack([torch.stack([-(1.0/8.0)*(1.0 - c2)*(1.0 - c3),
                                      -(1.0/8.0)*(1.0 - c1)*(1.0 - c3),
                                      -(1.0/8.0)*(1.0 - c1)*(1.0 - c2)]),
                         torch.stack([(1.0/8.0)*(1.0 - c2)*(1.0 - c3),
                                      -(1.0/8.0)*(1.0 + c1)*(1.0 - c3),
                                      -(1.0/8.0)*(1.0 + c1)*(1.0 - c2)]),
                         torch.stack([(1.0/8.0)*(1.0 + c2)*(1.0 - c3),
                                      (1.0/8.0)*(1.0 + c1)*(1.0 - c3),
