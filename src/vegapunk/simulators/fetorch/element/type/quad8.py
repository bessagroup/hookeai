...
class FEQuad8(ElementType):
    ...
    def _set_nodes_local_coords(self):
        ...
        nodes_local_coords[0, :] = torch.tensor((-1.0, -1.0))
        nodes_local_coords[1, :] = torch.tensor((1.0, -1.0))
        nodes_local_coords[2, :] = torch.tensor((1.0, 1.0))
        nodes_local_coords[3, :] = torch.tensor((-1.0, 1.0))
        nodes_local_coords[4, :] = torch.tensor((0.0, -1.0))
        nodes_local_coords[5, :] = torch.tensor((1.0, 0.0))
        nodes_local_coords[6, :] = torch.tensor((0.0, 1.0))
        nodes_local_coords[7, :] = torch.tensor((-1.0, 0.0))
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
