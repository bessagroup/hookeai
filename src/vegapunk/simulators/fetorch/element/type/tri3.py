...
class FETri3(Element):
    ...
    def eval_shapefun_deriv(self, local_coord):
        ...
        # Compute shape functions at given local coordinates
        shape_function_deriv[0, :] = torch.tensor((-1.0, -1.0))
        shape_function_deriv[1, :] = torch.tensor((1.0, 0.0))
        shape_function_deriv[2, :] = torch.tensor((0.0, 1.0))
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
