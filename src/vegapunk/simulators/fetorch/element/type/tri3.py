...
class FETri3(Element):
    ...
    def eval_shapefun_local_deriv(self, local_coord):
        ...
        # Compute shape functions at given local coordinates
        shape_fun_local_deriv[0, :] = torch.tensor((-1.0, -1.0))
        shape_fun_local_deriv[1, :] = torch.tensor((1.0, 0.0))
        shape_fun_local_deriv[2, :] = torch.tensor((0.0, 1.0))
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
