...
class FETri6(ElementType):
    ...
    def _set_nodes_local_coords(self):
        ...
        nodes_local_coords[3, :] = torch.tensor((0.5, 0.0))
        nodes_local_coords[4, :] = torch.tensor((0.5, 0.5))
        nodes_local_coords[5, :] = torch.tensor((0.0, 0.5))
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    def eval_shapefun(self, local_coords):
        ...
        shape_fun[0] = -(1.0 - c1 - c2)*(1.0 - 2.0*(1.0 - c1 - c2))
        shape_fun[1] = -c1*(1.0 - 2.0*c1)
        shape_fun[2] = -c2*(1.0 - 2.0*c2)
        shape_fun[3] = 4.0*c1*(1.0 - c1 - c2)
        shape_fun[4] = 4.0*c1*c2
        shape_fun[5] = 4.0*c2*(1.0 - c1 - c2)
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        return shape_fun
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
