"""Cross-validation of recurrent neural network model.

Functions
---------
kfold_cross_validation
    k-fold cross validation of recurrent neural network model.
"""
#
#                                                                       Modules
# =============================================================================
...
def kfold_cross_validation(cross_validation_dir, n_fold, n_max_epochs,
    ...
    """
    if is_verbose:
        print('\nRecurrent Neural Network model: k-fold cross-validation'
              '\n-------------------------------------------------------')
