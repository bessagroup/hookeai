"""Build directory structure for model convergence analysis with noisy data."""
#
#                                                                       Modules
# =============================================================================
# Standard
    ...
    if is_set_shared_testing_dataset:
        ...
        for noise_case in noise_dir_names:
            ...
            for dataset_name in dataset_dir_names:
                ...
                dest_testing_dataset_dir = os.path.join(
                    os.path.normpath(dest_dir), noise_case, dataset_name,
                    dataset_type_basename)
                # Remove existing destination data set directory
                if os.path.isdir(dest_testing_dataset_dir):
                    shutil.rmtree(dest_testing_dataset_dir)
                # Copy source testing data set directory to destination
                # directory
                shutil.copytree(src_testing_dataset_dir,
                                dest_testing_dataset_dir)