...
if __name__ == '__main__':
    ...
    # Set denoise method
    denoise_method = \
        ('moving_average', 'savitzky_golay', 'frequency_low_pass')[0]
    ...
    if denoise_method == 'moving_average':
        ...
        denoise_parameters = {'window_size': 10,
                              'poly_order': 2}
    ...
    for i in range(n_sample, n_sample + 1):
        ...
        denoised_strain_path = denoiser.denoise(
            noisy_strain_path, denoise_method, denoise_parameters,
        ...
        denoised_rmse = \
            torch.sqrt(loss_function(denoised_strain_path,
        ...
        for j, strain_comp in enumerate(strain_comps):
            ...
            axes.text(0.03, 0.03, rmse_str, fontsize=10, ha='left',
                      va='bottom', transform=axes.transAxes,
