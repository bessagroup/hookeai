...
def add_stress_features(dataset, stress_feature_label):
    ...
    stress_feature_label : {'vol', 'dev'}
        Stress-based feature:
        
        'vol' : Volumetric (or hydrostatic) stress.
        
        'dev' : Deviatoric component of stress tensor.
    ...
    available_stress_features = ('vol', 'dev')
...
def compute_stress_feature(stress_comps_array, stress_feature_label, n_dim,
    ...
    stress_feature_label : {'i1', 'i2'}
        Strain-based feature:
        
        'i1' : First (principal) invariant of stress tensor.
        
        'i2' : Second (principal) invariant of stress tensor.
...
if __name__ == '__main__':
    ...
    for stress_feature_label in ('vol', 'dev'):
