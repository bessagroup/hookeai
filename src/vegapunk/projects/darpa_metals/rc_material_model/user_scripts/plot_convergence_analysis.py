"""DARPA METALS PROJECT: Plot convergence analysis of RCM.
...
from projects.darpa_metals.rnn_material_model.rnn_model_tools. \
    convergence_plots import plot_prediction_loss_convergence, \
        plot_best_parameters_convergence, plot_time_series_convergence, \
...
def generate_convergence_plots(models_base_dirs, training_dirs, testing_dirs,
    ...
    if is_uncertainty_quantification:
        plot_best_parameters_convergence_uq(
            ...
            filename='best_parameters_convergence_uq',
            save_dir=save_dir, is_save_fig=is_save_fig,
            is_stdout_display=is_stdout_display,
            is_latex=is_latex)
    else:
        plot_best_parameters_convergence(
            models_base_dirs, training_dirs,
            filename='best_parameters_convergence',
            save_dir=save_dir, is_save_fig=is_save_fig,
            is_stdout_display=is_stdout_display,
            is_latex=is_latex)
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
