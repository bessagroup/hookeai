"""DARPA METALS PROJECT: Plot convergence analysis of hybrid material model.
...
def generate_convergence_plots(models_base_dirs, training_dirs, testing_dirs,
    ...
    if is_uncertainty_quantification:
        ...
        plot_time_series_convergence_uq(
            ...
            samples_ids=list(np.arange(10, dtype=int)),
...
if __name__ == "__main__":
    ...
    base_dir = ('/home/bernardoferreira/Documents/brown/projects/'
                'darpa_paper_examples/local/hybrid_models/gru')
