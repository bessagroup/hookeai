...
def generate_dataset(case_study_name, input_files_paths, data_files_paths,
                     dataset_directory, is_verbose=False, tube_id=None):
    """Generate data sets.
    ...
    if tube_id:
        dataset_basename = f'graph_dataset_tube_{str(tube_id)}'
    else:
...
if __name__ == "__main__":
    ...
    input_dir = ('/home/bernardoferreira/Documents/brown/projects/'
                 'abaqus_datasets/datasets/ABAQUS_M1_dynamics/'
                 'M1_test/')
    ...
    if is_testing_dataset:
        #tube_id = 101
        data_files_ids = [x for x in range(tube_id, tube_id + 1)]
    else:
        tube_id_init = 0
        tube_id_end = 63
        data_files_ids = [x for x in range(tube_id_init, tube_id_end + 1)]
    ...
    base_dir = ('/home/bernardoferreira/Documents/brown/projects/'
                'abaqus_datasets/case_studies/M1_dynamics/')
    # Set case study directory
    case_study_name = 'graph_datasets'
    ...
    if is_generate_dataset:
        ...
        dataset, _ = generate_dataset(case_study_name, input_files_paths,
                                    ...
                                    is_verbose=True, tube_id=tube_id)
