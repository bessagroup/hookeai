...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Set source data set file path
src_dataset_file_path = ('/home/bernardoferreira/Documents/brown/projects/'
                         'colaboration_shunyu/deliverable_04_02_2025/'
                         'deliverable_bernardo/8_gru_train_shunyu_test_shunyu/'
                         '5_testing_id_dataset/ss_paths_dataset_n260.pkl')
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    # Set data set file basename
    dataset_basename = 'ss_paths_time_series_dataset'
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
