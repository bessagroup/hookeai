...
reaction_array_dim = reaction_array[node_group_mask, 2 + load_direction_index]
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
for t in range(n_time):
    ...
    if ref_node_index > df_node.shape[0]:
       raise RuntimeError(f'Reference node {ref_node_label} does not exist '
                          f'in {simulation_name} simulation mesh.') 
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
