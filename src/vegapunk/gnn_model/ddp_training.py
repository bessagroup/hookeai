...
class DistributedTrainingTools:
    ...
    def save_training_state(model_ddp, optimizer, training_step,
        ...
        optimizer_state_file = model_ddp.module.model_name + '-optim'
    ...
    def load_training_state(self, rank, model_ddp, opt_algorithm, optimizer,
        ...
        if load_model_state == 'best':
            loaded_step = \
                model_ddp.module.load_model_state(special_state='best',
                                                  is_remove_posterior=True)
        elif load_model_state == 'last':
            loaded_step = \
                model_ddp.module.load_model_state(special_state='last',
                                                  is_remove_posterior=True)
        elif isinstance(load_model_state, int):
            loaded_step = model_ddp.module.load_model_state(
                training_step=load_model_state, is_remove_posterior=True)
        else:
            loaded_step = model_ddp.module.load_model_state()
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        # Set optimizer state file
