"""Uncertainty quantification: RC material model.
...
from user_scripts.local_model_update.rc_material_model.train_model import \
    perform_model_standard_training
from user_scripts.local_model_update.rc_material_model.predict import \
...
def plot_best_parameters_uq(model_sample_dirs, plot_data_dir,
    ...
    for i in range(n_model_sample):
        ...
        sample_model_dir = \
            os.path.join(os.path.normpath(sample_dir), '3_model')
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        # Set best parameters file path
        best_parameters_file_path = os.path.join(
            os.path.normpath(sample_model_dir), 'parameters_best.pkl')
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        # Load model best parameters
        best_model_parameters, _ = \
            read_best_parameters_from_file(best_parameters_file_path)
        # Store model parameters
        samples_best_model_parameters.append(best_model_parameters)
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    # Probe model parameters
    model_parameters_names = tuple(samples_best_model_parameters[0].keys())
    # Initialize model samples parameters data
    samples_parameters_data = \
        np.zeros((n_model_sample, len(model_parameters_names)))
    # Loop over model samples
    for i in range(n_model_sample):
...
if __name__ == "__main__":
    ...
    if is_convergence_analysis:
        ...
        training_sizes = (1, 2, 4, 8, 16, 32, 64, 128)
        # Set case study directories
