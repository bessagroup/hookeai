...
HookeAI provides an extensive set of pre-built tools to streamline the local model updating process.
...
* :code:`hookeai/user_scripts/local_model_update`: Directory containing a set of pre-configured user scripts to perform local model updating for the different pre-built material model architectures.
